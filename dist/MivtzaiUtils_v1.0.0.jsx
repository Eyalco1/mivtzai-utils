...
var importGoogleMaps = function (location) {
    ...
    var mapItem = app.project.importFile(new ImportOptions(File("".concat(File('.'), "/Scripts/ScriptUI Panels/MivtzaiUtils_v").concat(VERSION, " Assets/Images/").concat(location, "_Map_").concat(whichMap, ".png"))));
    var comp = app.project.activeItem;
...
var init = function (thisObj) {
    ...
    var iconsList = ['Boom', 'Tunnel', 'Terror Tunnel'];
