...
var getAssetsPath = function () {
    ...
    return ($.fileName.toString().replace("".concat(nameNoSpaces, "_v1.9.1.jsx"), '') +
        "".concat(nameNoSpaces, "_v1.9.1 Assets"));
};
...
var createAboutTab = function (tpanel) {
    ...
    var abtStr = '‹ Caspion - version 1.9.1 - Created By Eyal Cohen ›';
