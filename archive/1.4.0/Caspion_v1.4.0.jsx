...
var getAssetsPath = function () {
    ...
    return ($.fileName.toString().replace("".concat(nameNoSpaces, "_v1.4.0.jsx"), '') +
        "".concat(nameNoSpaces, "_v1.4.0 Assets"));
};
...
var createHelpWindow = function () {
    ...
    var abtStr = '‹ Caspion - version 1.4.0 - Created By Eyal Cohen ›';
