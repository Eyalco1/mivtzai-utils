...
const createAmbulanceIcon: CreateIconFn = (
    circleColor,
    iconColor,
    hasCircle,
    scale
    ...
    const createMagenDavidTriangle01 = () => {
        const vertices: [number, number][] = [
    ...
    const createMagenDavidTriangle02 = () => {
        const vertices: [number, number][] = [
    ...
    const createMagenDavidTriangle03 = () => {
        const vertices: [number, number][] = [
    ...
    const createMagenDavidTriangle04 = () => {
        const vertices: [number, number][] = [
    ...
    const createMagenDavidTriangle05 = () => {
        const vertices: [number, number][] = [
    ...
    const createMagenDavidTriangle06 = () => {
        const vertices: [number, number][] = [
    ...
    const createAmbulanceMagenDavidCenter = () => {
        const vertices: [number, number][] = [
...
const createTankIcon: CreateIconFn = (
    circleColor,
    iconColor,
    hasCircle,
    scale
...
const createGrenadeIcon: CreateIconFn = (
    circleColor,
    iconColor,
    hasCircle,
    scale
...
const createBoatIcon: CreateIconFn = (
    circleColor,
    iconColor,
    hasCircle,
    scale
...
const createBinocularsIcon: CreateIconFn = (
    circleColor,
    iconColor,
    hasCircle,
    scale
...
const createM16Icon: CreateIconFn = (
    circleColor,
    iconColor,
    hasCircle,
    scale
    ...
    const createR = () => {
        const vertices: [number, number][] = [
            [-13.0950317382812, 6.89993286132812],
            [-13.0950317382812, -10.5900573730469],
            [-25.4049682617188, -23.8200378417969],
            [-30.1649780273438, -19.2300720214844],
            [-30.1649780273438, 5.20993041992188],
            [-24.6349487304688, -0.19009399414062],
            [-24.6349487304688, 10.0799255371094],
            [-30.1649780273438, 10.3499450683594],
            [-30.1649780273438, 24.2099304199219],
            [30.1649780273438, 24.2099304199219],
            [30.1649780273438, 6.89993286132812]
        ];
        const inTangents: [number, number][] = [
            [0, 0],
            [0, 0],
    ...
    const createM = () => {
        const vertices: [number, number][] = [
            [63.5699768066406, -78.0850219726562],
            [37.6200256347656, -53.0549926757812],
            [-5.19003295898438, -55.5750122070312],
            [-15.7400207519531, -75.14501953125],
            [-63.5699768066406, -75.14501953125],
            [-63.5699768066406, -20.6950073242188],
            [-54.7099914550781, -21.0250244140625],
            [-63.5699768066406, -8.7149658203125],
            [-63.5699768066406, 2.59503173828125],
            [-44.6800231933594, -7.90496826171875],
            [5.77999877929688, 78.0850219726562],
            [28.1999816894531, 47.2449951171875],
            [-9.37997436523438, -26.114990234375],
            [54.6999816894531, -26.114990234375],
            [54.6999816894531, -31.875],
            [63.5699768066406, -31.875],
            [63.5699768066406, -45.875],
            [55.1600646972656, -45.4649658203125],
            [63.5699768066406, -53.6749877929688]
        ];
        const inTangents: [number, number][] = [
            [0, 0],
            [0, 0],
            ...
            [0, 0],
            [0, 0],
            [11.489990234375, -2.3900146484375],
            [0, 0],
            [0, 0],
            [0, 0],
            [0, 0],
        ...
        const outTangents: [number, number][] = [
            ...
            [0, 0],
            [0, 0],
            [16.2599487304688, -1.5],
            [2.3699951171875, 58.4099731445312],
            [0, 0],
            [-40.1199951171875, -25.9599609375],
            [0, 0],
            [0, 0],
            [0, 0],
            [0, 0],
    ...
    const createL = () => {
        const vertices: [number, number][] = [
            [66.7698211669922, -7.199951171875],
            [66.7698211669922, -61.4400024414062],
            [40.9498748779297, -61.4400024414062],
            [35.3498382568359, -42.8499755859375],
            [6.43986511230469, -41.8800048828125],
            [-6.25013732910156, -29.9099731445312],
            [-64.9601593017578, -28.5],
            [-66.7301788330078, 13.2200317382812],
            [-61.1301422119141, 26.260009765625],
            [20.8998260498047, -5.57000732421875],
            [20.0098724365234, -2.6099853515625],
            [3.48985290527344, 41.0700073242188],
            [-1.53016662597656, 61.4400024414062],
            [30.3398284912109, 60.8699951171875],
            [45.9798431396484, 15.760009765625],
            [66.7698211669922, 15.3500366210938],
            [66.7698211669922, 2.47003173828125],
            [51.8798675537109, 5.3699951171875],
            [54.2398529052734, -6.72998046875]
        ];
        const inTangents: [number, number][] = [
            [0, 0],
            [0, 0],
            ...
            [0, 0],
            [0, 0],
            [0.59002685546875, -16.22998046875],
            [0, 0],
            [0, 0],
            [0, 0],
            [6.78997802734375, -16.5199584960938],
            [0, 0],
            [0, 0],
            [0, 0],
            [-4.92999267578125, 1.22998046875],
            [0, 0],
            [7.76995849609375, 0.6300048828125],
            [0, 0]
        ];
        const outTangents: [number, number][] = [
            [0, 0],
            ...
            [0, 0],
            [0, 0],
            [-0.5899658203125, 16.22998046875],
            [0, 0],
            [0, 0],
            [0, 0],
            [-6.78997802734375, 16.52001953125],
            [0, 0],
            [0, 0],
            [9.1400146484375, 1.27001953125],
            [0, 0],
            [-2.5999755859375, 2.0999755859375],
            [0, 0],
            [0, 0]
        ];
...
const createIconFromId = (
    ...
    switch (id) {
        ...
        case 'Binoculars':
            ...
            break;
        case 'M16':
            createM16Icon(circleColor, iconColor, hasCircle, scale);
            break;
    }
